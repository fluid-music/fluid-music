...
//==============================================================================
bool OSCOutputStream::writeInt32 (int32 value)
{
    return output.writeIntBigEndian (value);
}

bool OSCOutputStream::writeUint64 (uint64 value)
{
...
bool OSCOutputStream::writeBlob (const MemoryBlock& blob)
{
...
bool OSCOutputStream::writeColour (OSCColour colour)
{
    return output.writeIntBigEndian ((int32) colour.toInt32());
}

bool OSCOutputStream::writeTimeTag (OSCTimeTag timeTag)
{
    return output.writeInt64BigEndian (int64 (timeTag.getRawTimeTag()));
}

bool OSCOutputStream::writeAddress (const OSCAddress& address)
{
    return writeString (address.toString());
}

bool OSCOutputStream::writeAddressPattern (const OSCAddressPattern& ap)
{
    return writeString (ap.toString());
}

bool OSCOutputStream::writeTypeTagString (const OSCTypeList& typeList)
{
    output.writeByte (',');
...
bool OSCOutputStream::writeArgument (const OSCArgument& arg)
{
    switch (arg.getType())
    {
...
//==============================================================================
bool OSCOutputStream::writeMessage (const OSCMessage& msg)
{
...
bool OSCOutputStream::writeBundle (const OSCBundle& bundle)
{
...
//==============================================================================
bool OSCOutputStream::writeBundleElement (const OSCBundle::Element& element)
{
